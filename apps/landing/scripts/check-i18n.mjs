...
// Resolve monorepo root based on this script's location: apps/web/scripts
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
const MONO_ROOT = path.resolve(__dirname, '..', '..', '..');
// Always check locales from the i18n package
const LOCALES_DIR = path.join(MONO_ROOT, 'packages', 'i18n', 'locales');
